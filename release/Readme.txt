...
五、引入 jquery-easyui-extensions 插件扩展库
    ...
    11.  可选，如果需要用到 easyui-ueditor 插件，则需要引入如下文件(根据服务器语言环境的不同，以下路径中 "ue1.4.3-utf8-net" 请更换成其对应的服务语言环境版本)
            plugins/ueditor/ue1_4_3-utf8-net/ueditor.config.js
            plugins/ueditor/ue1_4_3-utf8-net/ueditor.all.js
            plugins/ueditor/ue1_4_3-utf8-net/langh/zh-cn/zh-cn.js (可选，ueditor 的中文语言包)
