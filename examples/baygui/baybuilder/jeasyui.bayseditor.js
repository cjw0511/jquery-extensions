...
(function ($, undefined) {
    ...
    function showInsertBayDialog(bays, bayNo, callback) {
        ...
        $.util.exec(function () {
            ...
            deckForm.append("<span>行数：</span><input id=\"deckWidth\" class=\"easyui-numberspinner\" data-options=\"min: 1, max: 20\" style=\"width: 50px;\" value=\"6\" />");
            ...
            underForm.append("<span>行数：</span><input id=\"underWidth\" class=\"easyui-numberspinner\" data-options=\"min: 1, max: 20\" style=\"width: 50px;\" value=\"6\" />");
